...
- Always wrap code in a python markdown code block`;
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{ position: 'absolute', top: '100%', right: 0, zIndex: 50, width: 430, marginTop: 6, background: 'var(--bg2)', border: '1px solid var(--border2)', borderRadius: 4, boxShadow: '0 8px 32px rgba(0,0,0,0.5)', display: 'flex', flexDirection: 'column', maxHeight: 500 }}>
